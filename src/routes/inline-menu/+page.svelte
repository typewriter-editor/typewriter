<script lang="ts">
  import { Editor, InlineMenu, Root } from '$lib';
...
<div class="description">
  <h1>Inline Menu</h1>
  <p>Display a menu when the cursor is in an empty paragraph.</p>
</div>
...
<InlineMenu {editor} let:active let:commands>
  <div class="menu" in:fade={{ duration: 100 }}>
    ...
    <span class="separator"></span>
    <button class="menu-button" class:active={active.header === 3} on:click={commands.header3}>H3</button>
    <span class="separator"></span>
    <button class="menu-button" class:active={active.header === 4} on:click={commands.header4}>H4</button>
    <span class="separator"></span>
