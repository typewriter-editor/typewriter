<script lang="ts">
  import { asRoot, BubbleMenu, Editor } from '$lib';
...
<div class="description">
  <h1>Bubble Menu</h1>
  <p>Create a popup menu to display when text is selected without worrying about positioning.</p>
</div>

<BubbleMenu {editor} let:active let:commands let:placement offset={8}>
  <div class="menu">
    <div data-arrow class="arrow {placement}"></div>
    <button class="menu-button" class:active={active.header === 2} on:click={commands.header2}>
      <i class="material-icons">title</i>
    </button>

    <button class="menu-button header3" class:active={active.header === 3} on:click={commands.header3}>
      <i class="material-icons">title</i>
    </button>

    <button class="menu-button" class:active={active.bold} on:click={commands.bold}>
      <i class="material-icons">format_bold</i>
    </button>

    <button class="menu-button" class:active={active.italic} on:click={commands.italic}>
      <i class="material-icons">format_italic</i>
    </button>

    <button class="menu-button" class:active={active.link} on:click={commands.link}>
