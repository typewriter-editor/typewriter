<script lang="ts">
  import { asRoot, Editor, placeholder } from '$lib';
...
<div class="description">
  ...
  <p>Provide a placeholder in an empty text area. And ensure it works with various text alignments.</p>
</div>
