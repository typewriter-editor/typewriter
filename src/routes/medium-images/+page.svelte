<script lang="ts">
  import { asRoot, type AttributeMap, BubbleMenu, Editor, h, InlineMenu } from '$lib';
  ...
  editor.typeset.lines.add({
    ...
    fromDom: node => {
      ...
      const attr: AttributeMap = { image: img.src, alt: img.alt };
      if (node.dataset.style) attr.style = node.dataset.style;
      return attr;
    },
    render: attributes =>
      h('div', { class: 'image', 'data-style': attributes.style }, [
...
<BubbleMenu {editor} let:active let:commands let:placement offset={8}>
  <div class="bubble-menu">
    ...
    <button class="bubble-menu-button" class:active={active.header === 2} on:click={commands.header2}>
      <i class="material-icons">title</i>
    </button>

    <button class="bubble-menu-button header3" class:active={active.header === 3} on:click={commands.header3}>
      <i class="material-icons">title</i>
    </button>

    <button class="bubble-menu-button" class:active={active.bold} on:click={commands.bold}>
      <i class="material-icons">format_bold</i>
    </button>

    <button class="bubble-menu-button" class:active={active.italic} on:click={commands.italic}>
...
<InlineMenu {editor} let:active let:commands>
  <div class="inline-menu" in:fade={{ duration: 100 }}>
    <button class="inline-menu-button" class:active={active.header === 1} on:click={commands.header1}>H1</button>
    <span class="separator"></span>
    <button class="inline-menu-button" class:active={active.header === 2} on:click={commands.header2}>H2</button>
    <span class="separator"></span>
    <button class="inline-menu-button" class:active={active.header === 3} on:click={commands.header3}>H3</button>
    <span class="separator"></span>
    <button class="inline-menu-button" class:active={active.header === 4} on:click={commands.header4}>H4</button>
    <span class="separator"></span>
    <button class="inline-menu-button" class:active={active.hr} on:click={commands.hr}>–</button>
  </div>
</InlineMenu>
  ...
  <div class="bubble-menu">
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        ...
        <path
          d="M22,19 L22,21 L7,21 L7,19 L22,19 Z M22,15 L22,17 L16,17 L16,15 L22,15 Z M14,7 L14,17 L2,17 L2,7 L14,7 Z M22,11 L22,13 L16,13 L16,11 L22,11 Z M22,7 L22,9 L16,9 L16,7 L22,7 Z M22,3 L22,5 L7,5 L7,3 L22,3 Z"
        ></path>
      </svg>
    </button>
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        <rect fill="none" width="24" height="24" />
        <path d="M19,19 L19,21 L5,21 L5,19 L19,19 Z M19,7 L19,17 L5,17 L5,7 L19,7 Z M19,3 L19,5 L5,5 L5,3 L19,3 Z"
        ></path>
      </svg>
    </button>
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        <rect fill="none" width="24" height="24" />
        <path d="M19,19 L19,21 L5,21 L5,19 L19,19 Z M21,7 L21,17 L3,17 L3,7 L21,7 Z M19,3 L19,5 L5,5 L5,3 L19,3 Z"
        ></path>
      </svg>
    </button>
...
<div use:asRoot={editor} class="text-content">
  ...
  <div class="image">
    <img src="https://images.unsplash.com/photo-1612392062422-ef19b42f74df?fit=crop&w=600" alt="hotdogs" />
  </div>
  <p>
    Typewriter is a free, open source rich text editor built for the modern web. With its modular architecture and
    expressive API, it is completely customizable to fit any need.
