...
(function () {
      ...
      value: function mount(container) {
        ...
        var devObserver = new MutationObserver(function (list) {
          ...
          checking = setTimeout(function () {
            checking = 0;
            var diff = editor.contents.compose(_this6.decorations).diff(deltaFromDom$1(view));
            if (diff.length()) {
  ...
  var view$1 = new View(editor$1, {
    modules: _extends({}, defaultViewModules, {
