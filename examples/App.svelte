  ...
  <div class="app">
    ...
    <div class="app-body">
      ...
      <div class="app-menu">
        ...
        <a href="/table" class="menu-item" class:current={url === '/table'} use:link>Table</a>
        <a href="/description-list" class="menu-item" class:current={url === '/description-list'} use:link>Description List</a>
