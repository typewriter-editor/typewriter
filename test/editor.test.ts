...
describe('======== Editor ========', () => {
  ...
  describe('setText', () => {
    ...
    it('should set newlines', () => {
      ...
      expect(editor.getDelta().ops).toEqual([{ insert: 'Testing\nthis\nis\nfun\n' }]);
    });
  ...
  describe('insert text', () => {
    ...
    it('should insert text into the middle of a document', () => {
      ...
      expect(editor.getDelta().ops).toEqual([{ insert: 'TestFOOing this out\n' }]);
    });
    ...
    it('should delete text before inserting new text', () => {
      ...
      expect(editor.getDelta().ops).toEqual([{ insert: 'TestFOOthis out\n' }]);
    });
    ...
    it('should insert text with the provided formats', () => {
      ...
      expect(editor.getDelta().ops).toEqual([{ insert: 'Testing', attributes: { bold: true } }, { insert: '\n' }]);
    });
    ...
    it('should insert text and use the existing formats if non are provided', () => {
      ...
      expect(editor.getDelta().ops).toEqual([{ insert: 'TesFOOting', attributes: { bold: true } }, { insert: '\n' }]);
    });
    ...
    it('should insert at the beginning if the index is before the start', () => {
      ...
      expect(editor.getDelta().ops).toEqual([{ insert: 'This is a test!!\n' }]);
    });
  ...
  describe('delete', () => {
    it('should delete text', () => {
      ...
      expect(editor.getDelta().ops).toEqual([{ insert: 'Test out\n' }]);
    });
    ...
    it('should do nothing with a collapsed range', () => {
      ...
      expect(editor.getDelta().ops).toEqual([{ insert: 'Testing this out\n' }]);
    });
  });
});
